...
function Actions(config, cwd) {
  ...
  var setttingsJsonPath = path.resolve(this.cwd, 'private/settings.json');
...
Actions.init = function() {
  var destMupJson = path.resolve('private/mup.json');
  var destSettingsJson = path.resolve('private/settings.json');
